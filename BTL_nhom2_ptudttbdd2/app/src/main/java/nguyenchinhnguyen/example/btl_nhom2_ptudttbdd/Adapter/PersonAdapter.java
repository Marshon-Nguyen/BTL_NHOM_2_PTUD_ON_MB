package nguyenchinhnguyen.example.btl_nhom2_ptudttbdd.Adapter;
...
import nguyenchinhnguyen.example.btl_nhom2_ptudttbdd.DAO.PersonDAO;
import nguyenchinhnguyen.example.btl_nhom2_ptudttbdd.DTO.Person;
import nguyenchinhnguyen.example.btl_nhom2_ptudttbdd.R;
    ...
    public void onBindViewHolder(@NonNull PersonViewHolder holder, int position) {
        ...
        holder.imgEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Button btnCancel = dialog.findViewById(nguyenchinhnguyen.example.btl_nhom2_ptudttbdd.R.id.btnCancel);
